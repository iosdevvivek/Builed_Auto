...
- (void)layoutSubviews {
    ...
    if ([[[UIDevice currentDevice] systemVersion] floatValue] >= 7) {
        ...
        labelSize = [label.text sizeWithAttributes:dictonary];
    }else{
    ...
    CGSize detailsLabelSize = [detailsLabel.text sizeWithAttributes:@{NSFontAttributeName:[UIFont systemFontOfSize:12.0f]}];
