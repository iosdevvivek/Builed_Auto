...
- (id)init
{
    ...
    if (self) {
        ...
        CGRect contentFrame = CGRectMake(0.0, 64.0, masterRect.size.width, masterRect.size.height - 64.0);
        CGRect navBarFrame = CGRectMake(0.0, 0.0, masterRect.size.width, 64.0);
...
- (id)initWithRootViewController:(JWSlideMenuViewController *)rootViewController
{
    ...
    if(self) {
        ...
        UIBarButtonItem *menuButton = [[[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"menu-button.png"] style:UIBarButtonItemStyleBordered target:self.slideMenuController action:@selector(toggleMenu)] autorelease];
