...
- (id)initWithFields:(NSArray *)fields
{
    if (self = [super initWithFrame:CGRectMake(0.0f, 0.0f, 320.0f, 44.0f)])
    {
        ...
        //[self.segmentedControl setSegmentedControlStyle:UISegmentedControlStylePlain];
...
{
    /*yearTextF=(UITextField *)activeField;
    
    if(yearTextF.tag==2 || yearTextF.tag==4)
    {
        yearflag=YES;
...
- (void)doneButtonPressed:(id)sender
{
    if ([self.delegate respondsToSelector:@selector(keyboardControlsDonePressed:)])
    {
        ...
        /*if([yearTextField.text length]>0)
        {
        global_yearTextFieldValue=yearTextField.text;
        }*/
