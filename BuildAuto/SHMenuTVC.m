...
- (void)viewDidLoad
{
    self.tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, 250, self.view.frame.size.height) style:UITableViewStylePlain];
    ...
    [shadow setFrame:CGRectMake(218, 0, 43.5, self.view.frame.size.height)];
    ...
    [sbg setFrame:CGRectMake(0, 0, 250, self.view.frame.size.height)];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [bg setFrame:CGRectMake(0, 0, 250, 42.5)];
    // Configure the cell...
