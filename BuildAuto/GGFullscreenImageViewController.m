...
- (void) viewWillAppear:(BOOL)animated {
    ...
    [self.imageView setImageWithURL:url placeholderImage:[UIImage imageNamed:@"BuildAutoLogo_1.jpg"]];
    ...
    if (UIInterfaceOrientationIsPortrait(orientation)) {
        self.imageView.layer.bounds = CGRectMake(0, 0, self.view.frame.size.width, self.view.frame.size.width);
    } else {
